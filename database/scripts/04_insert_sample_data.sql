...
TRUNCATE TABLE transaction RESTART IDENTITY CASCADE;  -- MySQL: remove RESTART IDENTITY CASCADE
...
-- PostgreSQL: TRUNCATE TABLE "order" RESTART IDENTITY CASCADE;
...
-- 7. Insert Orders (PostgreSQL uses "order", MySQL uses `order`)
-- PostgreSQL version:
INSERT INTO "order" (date, total_amount, status, priority, customer_id, retailer_id) VALUES
(CURRENT_TIMESTAMP - INTERVAL '10 days', 124990.00, 'Delivered', 'High', 1, NULL),
(CURRENT_TIMESTAMP - INTERVAL '8 days', 95000.00, 'Delivered', 'Medium', 2, NULL),
(CURRENT_TIMESTAMP - INTERVAL '5 days', 67990.00, 'Shipped', 'Low', 3, NULL),
(CURRENT_TIMESTAMP - INTERVAL '3 days', 46994.00, 'Processing', 'Medium', 4, NULL),
(CURRENT_TIMESTAMP - INTERVAL '2 days', 134900.00, 'Pending', 'High', 5, NULL),
(CURRENT_TIMESTAMP - INTERVAL '1 day', 173490.00, 'Processing', 'High', 6, NULL),
(CURRENT_TIMESTAMP, 41989.00, 'Pending', 'Low', 7, NULL),
(CURRENT_TIMESTAMP, 19494.00, 'Pending', 'Medium', 8, NULL);
...
(1, 124990.00, 'Full Payment', 'Credit Card', 'Completed', CURRENT_TIMESTAMP - INTERVAL '10 days'),
(2, 95000.00, 'Full Payment', 'UPI', 'Completed', CURRENT_TIMESTAMP - INTERVAL '8 days'),
(3, 67990.00, 'Full Payment', 'Net Banking', 'Completed', CURRENT_TIMESTAMP - INTERVAL '5 days'),
(4, 46994.00, 'Full Payment', 'Debit Card', 'Completed', CURRENT_TIMESTAMP - INTERVAL '3 days'),
(5, 134900.00, 'Full Payment', 'Credit Card', 'Pending', NULL),
(6, 173490.00, 'Full Payment', 'UPI', 'Completed', CURRENT_TIMESTAMP - INTERVAL '1 day'),
...
(1, 'Delivered', 'BlueDart Express', 1, 'BD1234567890IN', CURRENT_DATE - INTERVAL '5 days', CURRENT_DATE - INTERVAL '6 days'),
(2, 'Delivered', 'DTDC Courier', 2, 'DT9876543210IN', CURRENT_DATE - INTERVAL '3 days', CURRENT_DATE - INTERVAL '4 days'),
(3, 'In Transit', 'FedEx India', 1, 'FX4567891230IN', CURRENT_DATE + INTERVAL '2 days', NULL),
(4, 'Preparing', 'Delhivery', 3, 'DV7891234560IN', CURRENT_DATE + INTERVAL '4 days', NULL),
(6, 'In Transit', 'BlueDart Express', 1, 'BD5678901234IN', CURRENT_DATE + INTERVAL '1 day', NULL);

-- MySQL version for dates (uncomment if using MySQL):
/*
INSERT INTO shipment (order_id, status, carrier, company_id, tracking_number, estimated_arrival, actual_arrival) VALUES
...
(1, CURRENT_TIMESTAMP - INTERVAL '10 days', 'Credit', 124990.00, 'Payment received for Order #1 - Dell XPS + Sony Headphones'),
(2, CURRENT_TIMESTAMP - INTERVAL '8 days', 'Credit', 95000.00, 'Payment received for Order #2 - Dell XPS 13'),
(3, CURRENT_TIMESTAMP - INTERVAL '5 days', 'Credit', 67990.00, 'Payment received for Order #3 - Samsung TV'),
(4, CURRENT_TIMESTAMP - INTERVAL '3 days', 'Credit', 46994.00, 'Payment received for Order #4 - Multiple items'),
(6, CURRENT_TIMESTAMP - INTERVAL '1 day', 'Credit', 173490.00, 'Payment received for Order #6 - Lenovo ThinkPad + HP Printer');
